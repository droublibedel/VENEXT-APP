...
@Controller()
export class InternalIndustrialOperationalContinuityDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/industrial-operational-continuity/domain-signal")
  ingest(
    ...
    this.gateway.ingestIndustrialOperationalContinuityDomainSignal(body);
    return { ok: true };
  }
}
