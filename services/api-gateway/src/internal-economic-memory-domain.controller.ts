...
@Controller()
export class InternalEconomicMemoryDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/economic-memory/domain-signal")
  ingest(
    ...
    this.gateway.ingestEconomicMemoryDomainSignal(body);
    return { ok: true };
  }
}
