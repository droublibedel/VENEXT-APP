...
@Controller()
export class InternalEconomicCommandDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/economic-command/domain-signal")
  ingest(
    ...
    this.gateway.ingestEconomicCommandDomainSignal(body);
    return { ok: true };
  }
}
