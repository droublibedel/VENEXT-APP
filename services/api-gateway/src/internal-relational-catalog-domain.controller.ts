...
@Controller()
export class InternalRelationalCatalogDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/relational-catalog/domain-signal")
  ingest(
    ...
    this.gateway.ingestRelationalCatalogDomainSignal(body);
    return { ok: true };
  }
}
