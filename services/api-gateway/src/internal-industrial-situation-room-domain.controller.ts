...
@Controller()
export class InternalIndustrialSituationRoomDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/industrial-situation-room/domain-signal")
  ingest(
    ...
    this.gateway.ingestIndustrialSituationRoomDomainSignal(body);
    return { ok: true };
  }
}
