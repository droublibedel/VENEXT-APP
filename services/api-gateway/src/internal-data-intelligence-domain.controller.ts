...
@Controller()
export class InternalDataIntelligenceDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/data-intelligence/domain-signal")
  ingest(
    ...
    this.gateway.ingestDataIntelligenceDomainSignal(body);
    return { ok: true };
  }
}
