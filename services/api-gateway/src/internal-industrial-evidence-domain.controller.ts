...
@Controller()
export class InternalIndustrialEvidenceDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/industrial-evidence/domain-signal")
  ingest(
    ...
    this.gateway.ingestIndustrialEvidenceDomainSignal(body);
    return { ok: true };
  }
}
