...
@Controller()
export class InternalEconomicCoordinationDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/economic-coordination/domain-signal")
  ingest(
    ...
    this.gateway.ingestEconomicCoordinationDomainSignal(body);
    return { ok: true };
  }
}
