...
@Controller()
export class InternalEconomicPropagationDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/economic-propagation/domain-signal")
  ingest(
    ...
    this.gateway.ingestEconomicPropagationDomainSignal(body);
    return { ok: true };
  }
}
