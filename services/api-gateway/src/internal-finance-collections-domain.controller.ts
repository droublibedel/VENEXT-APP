...
@Controller()
export class InternalFinanceCollectionsDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/finance-collections/domain-signal")
  ingest(
    ...
    this.gateway.ingestFinanceCollectionsDomainSignal(body);
    return { ok: true };
  }
}
