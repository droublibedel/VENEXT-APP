...
@Controller()
export class InternalCommercialCorridorDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/corridor-intelligence/domain-signal")
  ingest(
    ...
    this.gateway.ingestCorridorIntelligenceDomainSignal(body);
    return { ok: true };
  }
}
