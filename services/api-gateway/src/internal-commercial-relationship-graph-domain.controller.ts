...
@Controller()
export class InternalCommercialRelationshipGraphDomainController {
  constructor(private readonly gateway: RealtimeEconomicSignalGateway) {}

  @Post("internal/v1/realtime/commercial-relationship-graph/domain-signal")
  ingest(
    ...
    this.gateway.ingestCommercialRelationshipGraphDomainSignal(body);
    return { ok: true };
  }
}
