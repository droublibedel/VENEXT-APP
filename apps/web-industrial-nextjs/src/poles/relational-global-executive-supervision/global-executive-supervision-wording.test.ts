...
import { RELATIONAL_GLOBAL_EXECUTIVE_SUPERVISION_AI_CONTEXT } from "./ai-context";

const FORBIDDEN = RELATIONAL_GLOBAL_EXECUTIVE_SUPERVISION_AI_CONTEXT.forbidden.join(" ").toLowerCase();
