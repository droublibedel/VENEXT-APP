...
import { RELATIONAL_ECONOMIC_GOVERNANCE_AI_CONTEXT } from "./ai-context";

const FORBIDDEN = RELATIONAL_ECONOMIC_GOVERNANCE_AI_CONTEXT.forbidden.join(" ").toLowerCase();

describe("Instruction 20.30 — governance wording guard", () => {
