...
import { RelationalMacroObservatoryGovernancePanel } from "./RelationalMacroObservatoryGovernancePanel";

const SLUG = "relational-macro-observatory-governance" as const satisfies PoleSlug;
...
export default function PoleWorkspace() {
  ...
  const governanceEnabled = hydrated && flags.relational_macro_observatory_governance_enabled !== false;
  const realtimeEnabled = hydrated && flags.relational_macro_observatory_governance_realtime_enabled !== false;
