...
import { RELATIONAL_ECONOMIC_STABILIZATION_AI_CONTEXT } from "./ai-context";

const FORBIDDEN = RELATIONAL_ECONOMIC_STABILIZATION_AI_CONTEXT.forbidden.join(" ").toLowerCase();

describe("Instruction 20.32 — stabilization wording guard", () => {
