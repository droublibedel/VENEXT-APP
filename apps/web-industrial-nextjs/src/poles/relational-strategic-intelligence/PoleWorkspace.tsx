...
import { RelationalStrategicIntelligencePanel } from "./RelationalStrategicIntelligencePanel";

const SLUG = "relational-strategic-intelligence" as const satisfies PoleSlug;
...
export default function PoleWorkspace() {
  ...
  const intelligenceEnabled = hydrated && flags.relational_strategic_intelligence_enabled !== false;
  const realtimeEnabled = hydrated && flags.relational_strategic_intelligence_realtime_enabled !== false;
