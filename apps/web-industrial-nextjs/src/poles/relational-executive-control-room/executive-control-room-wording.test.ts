...
import { RELATIONAL_EXECUTIVE_CONTROL_ROOM_AI_CONTEXT } from "./ai-context";

const FORBIDDEN = RELATIONAL_EXECUTIVE_CONTROL_ROOM_AI_CONTEXT.forbidden.join(" ").toLowerCase();

describe("Instruction 20.39 — executive control room wording guard", () => {
