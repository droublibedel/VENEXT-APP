...
import { RelationalStrategicObservatoryPanel } from "./RelationalStrategicObservatoryPanel";

const SLUG = "relational-strategic-observatory" as const satisfies PoleSlug;
...
export default function PoleWorkspace() {
  ...
  const observatoryEnabled = hydrated && flags.relational_strategic_observatory_enabled !== false;
  const realtimeEnabled = hydrated && flags.relational_strategic_observatory_realtime_enabled !== false;
