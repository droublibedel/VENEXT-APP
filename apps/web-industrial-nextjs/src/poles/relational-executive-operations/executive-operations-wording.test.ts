...
import { RELATIONAL_EXECUTIVE_OPERATIONS_AI_CONTEXT } from "./ai-context";

const FORBIDDEN = RELATIONAL_EXECUTIVE_OPERATIONS_AI_CONTEXT.forbidden.join(" ").toLowerCase();

describe("Instruction 20.38 — executive operations wording guard", () => {
