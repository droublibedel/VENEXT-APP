...
import { RELATIONAL_EXECUTIVE_STRATEGIC_SYNTHESIS_AI_CONTEXT } from "./ai-context";

const FORBIDDEN = RELATIONAL_EXECUTIVE_STRATEGIC_SYNTHESIS_AI_CONTEXT.forbidden.join(" ").toLowerCase();

describe("Instruction 20.40 — executive strategic synthesis wording guard", () => {
