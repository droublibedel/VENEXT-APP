...
import { RELATIONAL_INSTITUTIONAL_REPORTING_AI_CONTEXT } from "./ai-context";

const FORBIDDEN = RELATIONAL_INSTITUTIONAL_REPORTING_AI_CONTEXT.forbidden.join(" ").toLowerCase();

describe("Instruction 20.35 — institutional reporting wording guard", () => {
