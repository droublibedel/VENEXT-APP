...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-operational-intelligence proxy targets.";

export async function proxyRelationalOperationalIntelligenceRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
