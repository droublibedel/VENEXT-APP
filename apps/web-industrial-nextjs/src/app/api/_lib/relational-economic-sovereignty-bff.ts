...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-economic-sovereignty proxy targets.";

export async function proxyRelationalEconomicSovereigntyRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
