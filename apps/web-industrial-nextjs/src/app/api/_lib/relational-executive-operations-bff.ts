...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-executive-operations proxy targets.";

export async function proxyRelationalExecutiveOperationsRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
