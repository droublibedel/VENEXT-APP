...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-global-executive-supervision proxy targets.";

export async function proxyRelationalGlobalExecutiveSupervisionRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
