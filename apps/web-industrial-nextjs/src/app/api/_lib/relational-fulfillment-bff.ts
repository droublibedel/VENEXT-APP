...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-fulfillment proxy targets.";

export async function proxyRelationalFulfillmentRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
