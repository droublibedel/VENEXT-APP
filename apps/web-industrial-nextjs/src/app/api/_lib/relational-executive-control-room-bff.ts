...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-executive-control-room proxy targets.";

export async function proxyRelationalExecutiveControlRoomRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
