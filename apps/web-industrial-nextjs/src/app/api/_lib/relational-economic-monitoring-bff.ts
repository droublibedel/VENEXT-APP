...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-economic-monitoring proxy targets.";

export async function proxyRelationalEconomicMonitoringRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
