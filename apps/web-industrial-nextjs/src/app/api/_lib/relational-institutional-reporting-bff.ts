...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-institutional-reporting proxy targets.";

export async function proxyRelationalInstitutionalReportingRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
