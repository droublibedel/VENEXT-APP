...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-operational-recommendation proxy targets.";

export async function proxyRelationalOperationalRecommendationRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
