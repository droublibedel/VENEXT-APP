...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-operational-simulation proxy targets.";

export async function proxyRelationalOperationalSimulationRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
