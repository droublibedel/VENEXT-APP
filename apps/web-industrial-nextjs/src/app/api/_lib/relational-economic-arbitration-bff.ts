...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-economic-arbitration proxy targets.";

export async function proxyRelationalEconomicArbitrationRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
