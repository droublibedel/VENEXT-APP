...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-strategic-observatory proxy targets.";

export async function proxyRelationalStrategicObservatoryRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
