...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-macro-economic proxy targets.";

export async function proxyRelationalMacroEconomicRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
