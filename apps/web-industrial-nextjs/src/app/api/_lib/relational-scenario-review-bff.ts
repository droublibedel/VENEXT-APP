...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-scenario-review proxy targets.";

export async function proxyRelationalScenarioReviewRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
