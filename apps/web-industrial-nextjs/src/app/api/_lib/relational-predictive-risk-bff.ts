...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-predictive-risk proxy targets.";

export async function proxyRelationalPredictiveRiskRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
