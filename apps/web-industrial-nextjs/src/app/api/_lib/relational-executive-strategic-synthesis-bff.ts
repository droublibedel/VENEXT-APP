...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-executive-strategic-synthesis proxy targets.";

export async function proxyRelationalExecutiveStrategicSynthesisRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
