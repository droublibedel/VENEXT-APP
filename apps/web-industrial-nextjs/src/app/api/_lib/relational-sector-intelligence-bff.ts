...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-sector-intelligence proxy targets.";

export async function proxyRelationalSectorIntelligenceRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
