...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-order-execution proxy targets.";

export async function proxyRelationalOrderExecutionRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
