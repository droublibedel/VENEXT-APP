...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-geo-economic proxy targets.";

export async function proxyRelationalGeoEconomicRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
