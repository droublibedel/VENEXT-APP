...
const CORE_HINT =
  "Set CORE_DOMAIN_URL or NEXT_PUBLIC_CORE_DOMAIN_URL for /api/relational-macro-observatory-governance proxy targets.";

export async function proxyRelationalMacroObservatoryGovernanceRequest(
  req: NextRequest,
  pathSegments: string[],
): Promise<Response> {
