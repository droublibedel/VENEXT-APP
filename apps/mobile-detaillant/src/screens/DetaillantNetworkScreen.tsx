    ...
    <section data-testid="detaillant-screen-network">
      ...
      {discoveryEnabled ? (
        ...
        <>
          ...
          <h2 style={{ fontSize: 15, margin: "0 0 10px", color: "#8fa39a", fontWeight: 600 }}>Fournisseurs actifs</h2>
          ...
          <h2 style={{ fontSize: 15, margin: "16px 0 10px", color: "#8fa39a", fontWeight: 600 }}>Nouveaux partenaires</h2>
          ...
          <h2 style={{ fontSize: 15, margin: "16px 0 10px", color: "#8fa39a", fontWeight: 600 }}>Activité ville</h2>
          ...
          <h2 style={{ fontSize: 15, margin: "16px 0 10px", color: "#8fa39a", fontWeight: 600 }}>Produits tendance</h2>
          {data?.trendingProducts.map((p) => (
            <article key={p.id} className="detaillant-card" data-testid={`detaillant-trend-${p.id}`}>
              <p style={{ margin: 0, fontWeight: 600 }}>{p.name}</p>
              <p style={{ margin: "6px 0 0", fontSize: 13, color: "#00a884" }}>{p.note}</p>
            </article>
          ))}
        </>
      )}
