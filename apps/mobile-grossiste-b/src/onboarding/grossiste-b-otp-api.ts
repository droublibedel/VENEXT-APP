...
export async function requestGrossisteBOtp(phone: string): Promise<RequestOtpResponse> {
...
export async function verifyGrossisteBOtp(phone: string, code: string): Promise<VerifyOtpResponse> {
